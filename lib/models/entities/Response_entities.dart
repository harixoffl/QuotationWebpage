class CMDmResponse {
  ...
  CMDmResponse({required this.code, this.message, Map<String, dynamic>? data}) : data = data ?? {}; // Defaults to an empty map if `null`
...
class CMDlResponse {
  ...
  CMDlResponse({required this.code, this.message, List<Map<String, dynamic>>? data}) : data = data ?? []; // Ensure `data` is never null
